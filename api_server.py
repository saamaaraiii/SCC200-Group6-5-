...
def parse_vms(xml_path: Path) -> Dict[str, Any]:
    """
    Parse VMS XML
    """
    try:
...
def get_corpus():
    ...
    """
    try:
        with open(DATA_DIR / 'CORPUSExtract.json', 'r') as f:
            data = json.load(f)
...
def get_smart():
    ...
    """
    try:
        with open(DATA_DIR / 'SMARTExtract.json', 'r') as f:
            data = json.load(f)
...
def get_bplan():
    ...
    """
    try:
        with open(DATA_DIR / 'bplan.txt', 'r') as f:
            data = f.read()
...
def get_vms():
    """
    GET /api/vms
    Returns VMS (Variable Message Signs) data
    Used by: iOS/Android for traffic messages
    """
    try:
        data = parse_vms(DATA_DIR / 'vms')
